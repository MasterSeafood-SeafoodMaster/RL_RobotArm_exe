...
$$
\begin{aligned}
& \mathrm{c} \theta_1 \mathrm{p}_{\mathrm{x}}=1_1 \mathrm{c}^2 \theta_1+1_2 \mathrm{c}^2 \theta_1 \mathrm{c} \theta_2-1_2 \mathrm{c} \theta_1 \mathrm{~s} \theta_1 \mathrm{~s} \theta_2 \\
& \mathrm{~s} \mathrm{p}_{\mathrm{y}}=1_1 \mathrm{~s}^2 \theta_1+1_2 \mathrm{~s} \theta_{\mathrm{c}} \theta_2+1_2 \mathrm{~s} \theta_1 \mathrm{c} \theta_1 \mathrm{~s} \theta_2 \\
& \mathrm{c} \theta_1 \mathrm{p}_{\mathrm{x}}+\mathrm{s} \theta_1 \mathrm{p}_{\mathrm{y}}=1_1\left(\mathrm{c}^2 \theta_1+\mathrm{s}^2 \theta_1\right)+1_2 \theta_2\left(\mathrm{c} \theta_1+\mathrm{s}^2 \theta_1\right)
\end{aligned}
$$

$$
\mathrm{c} \theta_1 \mathrm{p}_{\mathrm{x}}+\mathrm{s} \theta_1 \mathrm{p}_{\mathrm{y}}=1_1+1_2 \mathrm{c} \theta_2
$$

$$
\begin{aligned}
& -\mathrm{s} \theta_1 \mathrm{p}_{\mathrm{x}}=-1_1 \mathrm{~s} \theta_1 \mathrm{c} \theta_1-1_2 \mathrm{~s} \theta_1 \mathrm{c} \theta_1 \mathrm{c} \theta_2+1_1 \mathrm{~s}^2 \theta_1 \mathrm{~s} \theta_2 \\
& \mathrm{c} \theta_1 \mathrm{p}_{\mathrm{y}}=1_1 \mathrm{~s} \theta_1 \mathrm{c} \theta_1+1_2 \mathrm{c} \theta_1 \mathrm{~s} \theta_1 \mathrm{c} \theta_2+1_2 \mathrm{~s}^2 \theta_{\mathrm{s}} \\
& -\mathrm{s} \theta_1 \mathrm{p}_{\mathrm{x}}+\mathrm{c} \theta_1 \mathrm{p}_{\mathrm{y}}=1_2 \mathrm{~s} \theta_2\left(\mathrm{c}^2 \theta_1+\mathrm{s} \theta_1\right)
\end{aligned}
$$
