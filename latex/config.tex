...
\def\titleZh   {使用自然語言控制機器：探索大型語言模型在自動程式碼生成中的應用}   % Chinese title
\def\titleEn   {Controlling Machines with Natural Language: Explore the use of large language models in automated code generation} % English title
