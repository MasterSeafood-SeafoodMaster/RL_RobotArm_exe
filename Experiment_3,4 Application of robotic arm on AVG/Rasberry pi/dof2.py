...
class Arm:
    def __init__(self):
        ...
        self.kit.servo[3].set_pulse_width_range(480, 2525)
        self.isgrab=True
        self.move()
        self.release()
        time.sleep(3)

    def move(self, mode="grab", va3=0):
        ...
        if b>-1:
            ...
            if mode=="grab":
                ...
                self.aList=[b, a1, a2, a3]
            else:
                self.kit.servo[3].angle=int(va3)
                self.aList=[b, a1, a2, va3]
            
    
    def grab(self):
        if not self.isgrab:
            for i in range(110, 180, 5): 
